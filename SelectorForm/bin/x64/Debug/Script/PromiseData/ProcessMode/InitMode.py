...
def FetchStockBasic():
    df0 = tu.pro.stock_basic(exchange_id='', is_hs='N', fields='ts_code,symbol,name,exchange_id,list_date');
    df0['is_hs'] = pd.Series('N', df0.index);
    df1 = tu.pro.stock_basic(exchange_id='', is_hs='H', fields='ts_code,symbol,name,exchange_id,list_date');
    df1['is_hs'] = pd.Series('H', df1.index);
    df2 = tu.pro.stock_basic(exchange_id='', is_hs='S', fields='ts_code,symbol,name,exchange_id,list_date');
